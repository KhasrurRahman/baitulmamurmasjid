...
const de = {
  ...
  fund: {
    ...
    factLabels: {
      purchasePrice: "Kaufpreis der Immobilie",
      deadline: "Frist für den Kaufpreis",
      renovationCost: "Bereits investiert in Renovierung (2025)",
      donorGoal: "Angestrebte Spender",
      monthlyMin: "Mindestbeitrag pro Person",
    },
    currencyWord: "€",
    peopleUnit: "Personen",
    monthUnit: "Monat",
...
const bn: typeof de = {
  ...
  fund: {
    ...
    factsTitle: "মূল তথ্য",
    factLabels: {
      purchasePrice: "সম্পত্তির ক্রয়মূল্য",
      deadline: "ক্রয়মূল্য পরিশোধের সময়সীমা",
      renovationCost: "সংস্কারে ইতিমধ্যে বিনিয়োগ (২০২৫)",
      donorGoal: "লক্ষ্যভুক্ত দাতা সংখ্যা",
      monthlyMin: "প্রতি ব্যক্তির সর্বনিম্ন অনুদান",
    },
    currencyWord: "ইউরো",
    peopleUnit: "জন",
    monthUnit: "মাস",
